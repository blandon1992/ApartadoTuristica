...
public class OasisActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng arvi = new LatLng(7.868530, -76.636207);
        ...
        setmMarker(arvi,"Parque Oasis","Sitio Turístico");
